...
Scrapes shoes from https://eu.crockettandjones.com/collections/all-womens-styles
...
class CrocettJonesScraper:
    """Crockett & Jones shoes scraper with pagination support."""

    def __init__(
        self,
        base_url: str = "https://eu.crockettandjones.com/collections/all-womens-styles",
    ):
...
async def main():
    ...
    scraper = CrocettJonesScraper(
        base_url="https://eu.crockettandjones.com/collections/all-womens-styles"
    )
